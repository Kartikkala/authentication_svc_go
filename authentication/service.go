...
func (svc *Service) RegisterService(ctx context.Context, email string, username string, password string) (uint64, error) {
	if email == "" || username == "" || password == "" {
		return 0, errors.New("email, username, and password cannot be empty")
	}
...
func (svc *Service) DecodeToken(token *string) (*CustomClaims, error) {
